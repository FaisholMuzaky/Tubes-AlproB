...
public class modelKendaraan {
    ...
    public static ResultSet searchKendaraan(int idPengguna) {
        ...
        try {
            ...
            String query = "SELECT a.idKendaraan, a.platNomor, a.tipeKendaraan "+
                "FROM kendaraan a JOIN pengguna b ON a.idPemilik=b.idPengguna WHERE b.idPengguna ='" + idPengguna + "'";
